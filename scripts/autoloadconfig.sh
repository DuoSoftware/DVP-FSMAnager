...
sed -i 's^<param name="ext-rtp-ip" value="auto-nat"/>^<param name="ext-rtp-ip" value="'$FS_EXTERNALIP'"/>^g; s^<param name="ext-sip-ip" value="auto-nat"/>^<param name="ext-sip-ip" value="'$FS_EXTERNALIP'"/>^g; s^<param name="force-register-domain" value="$${domain}"/>^<!--<param name="force-register-domain" value="$${domain}"/>-->^g; s^<param name="force-subscription-domain" value="$${domain}"/>^<!--<param name="force-subscription-domain" value="$${domain}"/>-->^g; s^<param name="force-register-db-domain" value="$${domain}"/>^<!--<param name="force-register-db-domain" value="$${domain}"/>-->^g' /usr/local/src/xml/internal.xml;
